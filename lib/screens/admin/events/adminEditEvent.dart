...
TimeOfDay time;
  ...
  TimeOfDay timesEvent = TimeOfDay.fromDateTime(DateTime.parse(newEventTime)); // 4:30pm
  print('printing time');
  print(timesEvent);
  ...
  Future updateData(BuildContext Context, id, eventName, eventDescription,
      eventVenue, eventAmount, eventDate, eventDeadline, eventTime, eventType) async {
    ...
    DateTime new_time =  DateTime(now.year, now.month, now.day, selected_time.hour, selected_time.minute);
